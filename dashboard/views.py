...
def dashboard(request):
	...
	return render(request,'dashboard/dashboard_index.html',{'leave_list':leaves_all,'dataset':dataset})
...
def leave_creation(request):
	...
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			messages.success(request,'Leave Request Sent,wait for Aditya Managers response',extra_tags = 'alert alert-success alert-dismissible show')
